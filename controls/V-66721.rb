control 'V-66721' do
  ...
  tag "check": 'Verify a JRE deployment configuration file exists as indicated: /etc/.java/deployment/deployment.config If the configuration file does not exist as indicated, this is a finding.'
