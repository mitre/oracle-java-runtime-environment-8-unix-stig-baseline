control 'V-66911' do
  ...
  tag "check": 'Navigate to the system-level “deployment.properties” file for JRE. /etc/.java/deployment/deployment.properties If there is no file entitled “deployment.properties”, this is a finding.'

  tag "fix": 'Create the Java deployment properties file “/etc/.java/deployment/deployment.properties”'
